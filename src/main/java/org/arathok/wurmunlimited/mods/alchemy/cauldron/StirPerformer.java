...
public class StirPerformer implements ActionPerformer {


    public ActionEntry actionEntry;


    public StirPerformer() {
        int[] types;
        if (Config.potionsDuringFighting) {
            ...
            actionEntry = new ActionEntryBuilder((short) ModActions.getNextActionId(), "Stir Cauldron", "stirring",
                    types)
